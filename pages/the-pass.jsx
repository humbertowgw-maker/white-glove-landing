    ...
    <>
      ...
      <style jsx global>{`
        ...
        *{box-sizing:border-box}html{background:var(--paper);scroll-behavior:smooth}
        ...
        @media(max-width:820px){.hero{grid-template-columns:1fr;gap:46px;padding-top:62px}.section-head{display:block}.section-head p{margin-top:18px}.brigade-grid{grid-template-columns:1fr}.chef-card{min-height:230px}.chef-role{margin-top:45px}}
        @media(max-width:520px){.pass-nav,.hero,.brigade,.pass-footer{width:calc(100% - 28px)}.pass-nav{padding-top:17px}.hero{padding:54px 0 60px}h1{font-size:28vw}.hero-copy>p{font-size:15px}.order-ticket{padding:21px}.pass-footer{flex-direction:column;line-height:1.6}}
      `}</style>
